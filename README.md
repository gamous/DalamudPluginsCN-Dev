...
| 插件名称                                                     | 介绍                                                         | 插件作者                                        | 本地化维护                                            | 汉化 | 下载量                                                       |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ----------------------------------------------- | ----------------------------------------------------- | ---- | ------------------------------------------------------------ |
| [AutoAction](https://github.com/ArchiDog1998/XIVAutoAction)  | 自动技能（战斗与制作）                                       | [ArchiDog1998](https://github.com/ArchiDog1998) | -                                                     | √    | [![Github Latest Releases](https://img.shields.io/github/downloads/moewcorp/AutoAction/latest/total.svg?label=)]()[![Github All Releases](https://img.shields.io/github/downloads/moewcorp/AutoAction/total.svg?label=)]() |
...
| [AutoMiniGame](https://github.com/gamous/AutoMiniGame)       | 金碟小游戏辅助                                               | [gamous](https://github.com/gamous)             | -                                                     | √    | [![Github Latest Releases](https://img.shields.io/github/downloads/moewcorp/AutoMiniGame/latest/total.svg?label=)]()[![Github All Releases](https://img.shields.io/github/downloads/moewcorp/AutoMiniGame/total.svg?label=)]() |
